...
class RENEGE:
    ...
    def process_email(self, new_emails, clean_option):
        '''
        ...
        for email in emails["dataset"]:    
            ...
            date    = data["Date"]            
            body    = data["Body"]
            is_spam = self.e_mail.is_spam(subject,body,clean_option)
    ...
    def get_user_trust(self, email):
        ...
        for group_name in user_groups:
            ...
            averages_sum = averages_sum + group_average
